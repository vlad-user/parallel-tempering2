...
#do
#
#                python ../main.py --exp_name test_resnet_lr_no_swap --exchange_type no_swap --hp_to_swap learning_rate --epochs 350  --model_name resnet20 --model_builder resnet20_v1_cifar10_builder  --lr_min 0.0007 --lr_max 0.002 --dropout_rate_min 0. --dropout_rate_max 0. --n_replicas 8 --batch_size 128 --train_data_size 45000  --random_seed ${i} --notes back_to_equidistant    --proba_coeff_C  0.5 --swap_step 300 --use_ensemble_model
#done
for i in "${rs[@]}"
do
                python ../main.py --exp_name test_resnet_lr_swap_sort --exchange_type swap_sort --hp_to_swap learning_rate --epochs 350  --model_name resnet20 --model_builder resnet20_v1_cifar10_builder  --lr_min 0.0007 --lr_max 0.002 --dropout_rate_min 0. --dropout_rate_max 0. --n_replicas 8 --batch_size 128 --train_data_size 45000  --random_seed ${i} --notes back_to_equidistant    --proba_coeff_C  0.5 --swap_step 400 --use_ensemble_model
done
for i in "${rs[@]}"
do
                python ../main.py --exp_name test_resnet_lr_swap_sort_adj --exchange_type swap_sort_adj --hp_to_swap learning_rate --epochs 350  --model_name resnet20 --model_builder resnet20_v1_cifar10_builder  --lr_min 0.0007 --lr_max 0.002 --dropout_rate_min 0. --dropout_rate_max 0. --n_replicas 8 --batch_size 128 --train_data_size 45000  --random_seed ${i} --notes C_equals_2_at_90k_steps    --proba_coeff_C  0.5 --swap_step 400 --use_ensemble_model
done
