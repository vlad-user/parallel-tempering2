...
do
  ...
  python ../main.py --exp_name test_resnet_lr_swap_sort --exchange_type swap_sort --hp_to_swap learning_rate --epochs 200  --model_name resnet20 --model_builder resnet20_v1_cifar10_builder  --lr_min 0.0005 --lr_max 0.05 --dropout_rate_min 0. --dropout_rate_max 0. --n_replicas 8 --batch_size 128 --train_data_size 45000  --random_seed ${i} --notes  make_sure_lr_bounds_are_ok  --proba_coeff_C  1. --use_ensemble_model

#  python ../main.py --exp_name test_resnet_lr_swap_sort_adj --exchange_type swap_sort_adj --hp_to_swap learning_rate --epochs 200  --model_name resnet20 --model_builder resnet20_v1_cifar10_builder  --lr_min 0.0005 --lr_max 0.05 --dropout_rate_min 0. --dropout_rate_max 0. --n_replicas 8 --batch_size 128 --train_data_size 45000  --random_seed ${i} --notes  make_sure_lr_bounds_are_ok  --proba_coeff_C  1. --use_ensemble_model
#
#  python ../main.py --exp_name test_resnet_lr_no_swap --exchange_type no_swap --hp_to_swap learning_rate --epochs 200  --model_name resnet20 --model_builder resnet20_v1_cifar10_builder  --lr_min 0.0005 --lr_max 0.05 --dropout_rate_min 0. --dropout_rate_max 0. --n_replicas 12 --batch_size 128 --train_data_size 45000  --random_seed ${i} --notes  more_replicas  --proba_coeff_C  1. --use_ensemble_model
#
#  python ../main.py --exp_name test_resnet_lr_swap_sort --exchange_type swap_sort --hp_to_swap learning_rate --epochs 200  --model_name resnet20 --model_builder resnet20_v1_cifar10_builder  --lr_min 0.0005 --lr_max 0.05 --dropout_rate_min 0. --dropout_rate_max 0. --n_replicas 12 --batch_size 128 --train_data_size 45000  --random_seed ${i} --notes  more_replicas  --proba_coeff_C  1. --use_ensemble_model
